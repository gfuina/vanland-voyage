  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="/images/hero_van.jpeg"
          alt="Aménagement de van"
          fill
          ...
          >
            ...
            >
              <span className="inline-flex items-center gap-2 px-5 py-3 bg-accent text-navy font-bold text-sm rounded-2xl shadow-lg -rotate-1 hover:rotate-0 transition-transform duration-300">
                ...
                Artisans passionnés près de Tours
              </span>
            </motion.div>
            ...
            >
              Avec nous, un projet d'aménagement de van devient{" "}
              <span className="text-accent">une expérience unique</span>
            </motion.h1>
