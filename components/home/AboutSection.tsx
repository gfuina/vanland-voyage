...
import humourAnimation from "@/public/lotties/humour.json";
import passionAnimation from "@/public/lotties/passion.json";
    ...
    <section className="py-24 lg:py-40 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div {...animation} className="space-y-6 lg:order-2">
            <div>
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              Notre mission est de rendre tous vos projets accessibles !
            </p>
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              rénovation, réparation ou amélioration, conseil et vente de
              matériels pour votre van, fourgon et/ou camping-car. Nous
              travaillons sur tous les types de véhicule, et qu'ils soient
              d'occasion ou neuf.
            </p>
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4 pt-4">
              {[
                ...
                {
                  animation: passionAnimation,
                  text: "Passion",
                  rotate: "-rotate-2",
                },
                {
                  animation: humourAnimation,
                  text: "Humour",
                  rotate: "rotate-2",
                },
              ].map((item, index) => (
                ...
                >
                  ...
                  <span className="font-semibold text-navy text-sm sm:text-base text-center sm:text-left">
                    {item.text}
                  </span>
                </div>
              ))}
          ...
          <motion.div {...animation} className="relative lg:order-1">
            <div
